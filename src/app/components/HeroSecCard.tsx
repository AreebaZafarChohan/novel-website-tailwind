...
const HeroSecCard: React.FC<NovelCardProps> = ({ title, author, description, image, pdf, onlineRead }) => {
  return (
    <div className="bg-gray-100 border p-4 rounded-lg shadow-lg flex flex-col items-center w-[90%] sm:w-[80%] md:w-[90%] lg:w-[90%] mx-auto transition-transform transform hover:scale-105 h-auto m-6">
      <Image
        src={image}
        alt={`${title} Cover`}
        width={200}
