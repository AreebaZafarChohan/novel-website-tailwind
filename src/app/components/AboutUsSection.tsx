...
const AboutUsSection: React.FC = () => {
  ...
  const englishText = (
    <div className='border-2 p-4 rounded-lg hover:bg-slate-300 hover:text-black font-serif '>
      ...
      <p className="text-lg">
        Welcome to Ishq Aur Afsanay, your ultimate destination for exploring the captivating world of novels.
  ...
  const urduText = (
    <div className='border-2 p-4 rounded-lg font-serif hover:bg-slate-300 hover:text-black'>
      ...
      <p className="text-lg">
        عشق اور افسانے میں خوش آمدید، آپ کا حتمی مقام کہانیوں کی دلکشی کو دریافت کرنے کے لئے۔
